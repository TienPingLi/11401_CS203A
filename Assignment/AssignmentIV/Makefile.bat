...
REM Flags
REM CFLAGS=-std=c23 -Wall -Wextra -Wpedantic -g
REM CXXFLAGS=-std=c++23 -Wall -Wextra -Wpedantic -g
set CFLAGS=-Wall -Wextra -Wpedantic -g
set CXXFLAGS=-Wall -Wextra -Wpedantic -g
